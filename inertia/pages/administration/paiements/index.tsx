...
export default function PaiementsIndex() {
  ...
  // ── Rendu de l'UI ────────────────────────────────────────────────────────────
  return (
    <AdminLayout title="Ventes Manuels & Paiements">
      <Head title="Paiements — Admin ACADIS" />
      
      {/* Header de Page */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black text-gray-900">Paiements Manuels</h1>
          <p className="text-gray-500 mt-1">Caisse et suivi des ventes de manuels pour les étudiants.</p>
        </div>
        <button 
      ...
      <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-col sm:flex-row gap-4 mb-6">
        <div className="flex-1 relative">
          ...
          <input
            type="text"
            placeholder="Rechercher par étudiant, ID Facture ou Manuel..."
            value={search}
